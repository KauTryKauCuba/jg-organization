    ...
    return (
        <>
            ...
            <div className="relative flex min-h-screen flex-col items-center bg-[#FDFDFC] p-6 text-[#1b1b18] lg:justify-center lg:p-8 dark:bg-[#0a0a0a]">
                ...
                <div className="relative z-10 w-full flex flex-col items-center lg:grow">
                <header className="mb-6 w-full max-w-[335px] text-sm not-has-[nav]:hidden lg:max-w-4xl">
                    <nav className="flex items-center justify-end gap-4">
                        <div className={`flex items-center gap-2 rounded-full border px-3 py-1.5 text-xs font-medium shadow-sm backdrop-blur-md ${
                            dbStatus 
                                ? 'border-emerald-800/50 bg-emerald-950/50 text-emerald-400 dark:border-emerald-800/50 dark:bg-emerald-950/50 dark:text-emerald-400'
                                : 'border-red-800/50 bg-red-950/50 text-red-400 dark:border-red-800/50 dark:bg-red-950/50 dark:text-red-400'
                        }`}>
                            <div className={`h-2 w-2 rounded-full ${dbStatus ? 'bg-emerald-500 animate-pulse' : 'bg-red-500'}`} />
                            <span className="hidden sm:inline">{dbStatus ? 'Database Connected' : 'Database Disconnected'}</span>
                            <span className="sm:hidden">{dbStatus ? 'DB OK' : 'DB Err'}</span>
                        </div>
                        {auth.user ? (
                            <Link
                                href={dashboard()}
                                className="inline-block rounded-sm border border-[#3E3E3A] px-5 py-1.5 text-sm leading-normal text-[#EDEDEC] hover:border-[#62605b] dark:border-[#3E3E3A] dark:text-[#EDEDEC] dark:hover:border-[#62605b]"
                            >
                                Dashboard
                            </Link>
                        ) : (
                            <>
                                <Link
                                    href={login()}
                                    className="inline-block rounded-sm border border-transparent px-5 py-1.5 text-sm leading-normal text-[#EDEDEC] hover:border-[#3E3E3A] dark:text-[#EDEDEC] dark:hover:border-[#3E3E3A]"
                                >
                                    Log in
                                </Link>
                                {canRegister && (
